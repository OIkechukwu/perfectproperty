...
<div class="collapse navbar-collapse" id="navbarToggler">
    ...
    <li class="nav-item">
        <a class="nav-link btn-action my-1 text-center my-md-0" href="#">Login</a>
    </li>
    <li class="nav-item">
        <a class="nav-link btn-action my-1 text-center my-md-0" href="#">Sign Up</a>
    </li>
    </ul>
</div>
</nav>
...
<div class="row">
    ...
    <div class="col-md-3 text-light">
        <p class="offset-1 pl-3 footer_headings">Perfect property nigeria</p>
        <ul>
    ...
    <div class="col-md-3 text-light">
        <p class="offset-1 pl-3 footer_headings">Services</p>
        <ul>
...
<div class="row">
    <div class="col-md-12 text-light text-center py-2">
        <span id="copyright" class="outline-rounded">c</span>
